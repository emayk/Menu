...
class MenuItem
{
    ...
    public function __toString()
    {
        ...
        $s .= isset($this->_role['li']) ? ' role="' . $this->_role['li'] . '"' : "";
        $s .= isset($this->_data_toggle['li']) ? ' data-toggle="' . $this->_data_toggle['li'] . '"' : '';
        $s .= isset($this->_data_target['li']) ? ' data-target="' . $this->_data_target['li'] . '"' : "";
        $s .= isset($this->_aria_labelledby['li']) ? ' aria-labelledby="' . $this->_aria_labelledby['li'] . '"' : "";
        $s .= '>';
        $s .= '<a href="' . $this->_url . '"';
        $s .= isset($this->_class['a']) ? ' class="' . $this->_class['a'] . '"' : '';
        $s .= isset($this->_id['a']) ? ' id="' . $this->_id['a'] . '"' : '';
        $s .= isset($this->_role['a']) ? ' role="' . $this->_role['a'] . '"' : "";
        $s .= isset($this->_data_toggle['a']) ? ' data-toggle="' . $this->_data_toggle['a'] . '"' : '';
        $s .= isset($this->_data_target['a']) ? ' data-target="' . $this->_data_target['a'] . '"' : "";
        $s .= isset($this->_aria_labelledby['a']) ? ' aria-labelledby="' . $this->_aria_labelledby['a'] . '"' : "";
        $s .= '>' . $this->_title;
